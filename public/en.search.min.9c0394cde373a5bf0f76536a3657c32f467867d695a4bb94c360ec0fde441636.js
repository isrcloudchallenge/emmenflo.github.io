'use strict';(function(){const searchDataURL='/en.search-data.min.1ba1974a6939e1103594edeef200ec9b72a8ea88b5d7dfbf73db12f6bfef0f1d.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
