'use strict';(function(){const searchDataURL='/en.search-data.min.5e75db3cf8551430341c25279142d45357ef016ae9511a871ad6551313550839.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
